...
export class URL {
    static USER_URL = environment.API_URL + '/api/users';
    static CATEGORY_URL = environment.API_URL + '/api/categories';
    static TRACK_URL = environment.API_URL + '/api/tracks';
    static STORE_URL = environment.API_URL + '/api/stores';
    static INVOICE_URL = environment.API_URL + '/api/invoices';
    static ITEM_URL = environment.API_URL + '/api/items';
    static AUTH_INVOICE_URL = environment.API_URL + '/api/auth-users/invoice-users';
    static AUTH_DEFAULT_SETTING_ADMIN_URL = environment.API_URL + '/api/auth-stores/default-setting-admins';
    static AUTH_PACKAGE_ADMIN_URL = environment.API_URL + '/api/auth-stores/package-admins';
    static AUTH_STORE_ADMIN_URL = environment.API_URL + '/api/auth-stores/store-admins';
    static AUTH_PAYMENT_METHOD_ADMIN_URL = environment.API_URL + '/api/auth-stores/payment-method-admins';
    static AUTH_STATEMENT_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/statement-admins';
    static AUTH_CATEGORY_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/category-contributors';
    static AUTH_CARD_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/card-contributors';
    static AUTH_DEFAULT_SETTING_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/default-setting-contributors';
    static AUTH_INVOICE_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/invoice-contributors';
    static AUTH_INVOICE_CONFIGURATION_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/invoice-configuration-contributors';
    static AUTH_CUSTOMER_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/customer-contributors';
    static AUTH_PROMOTION_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/promotion-contributors';
    static AUTH_DELIVERY_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/delivery-contributors';
    static AUTH_ANALYSIS_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/analysis-contributors';
    static AUTH_ITEM_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/item-contributors';
    static AUTH_STORE_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/store-contributors';
    static AUTH_TABLE_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/ordering-contributors/table-contributors';
    static AUTH_SALE_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/ordering-contributors/sale-contributors';
    static AUTH_ORDERING_CONFIGURATION_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/ordering-contributors/ordering-configuration-contributors';
    static AUTH_PACKAGE_CONTRIBUTOR_URL = environment.API_URL + '/api/auth-stores/package-contributors'
    static AUTH_STORE_USER_URL = environment.API_URL + '/api/auth-users/store-users';
    static AUTH_USERS_URL = environment.API_URL + '/api/auth-users';
    static AUTH_TRACK_CONTRIBUTORS_URL = environment.API_URL + '/api/auth-stores/track-contributors'
    static AUTH_NOTIFICATION_USERS_URL = environment.API_URL + '/api/auth-users/notification-users';
    static FEATURE_URL = environment.API_URL + '/api/features';
    static CURRENCY_URL = environment.API_URL + '/api/currency';
