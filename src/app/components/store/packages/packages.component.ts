...
export class PackagesComponent implements OnInit {
  ...
  constructor(private http: HttpClient,
    ...
    private sharedPackageService: SharedPackageService) { 
      this.store_username = this.sharedStoreService.store_username;
      ...
      this.authStoreUserService.getAuthenticatedStoreByStoreUsername(this.store_username).pipe(takeUntil(this.ngUnsubscribe)).subscribe(() => {});
  }
