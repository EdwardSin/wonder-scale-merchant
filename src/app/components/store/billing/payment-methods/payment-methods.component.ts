...
import { AuthPaymentMethodAdminService } from '@services/http/auth-store/admin/auth-payment-method-admin.service';
...
export class PaymentMethodsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    DocumentHelper.setWindowTitleWithWonderScale('Payment Methods - ' + store_name);
    this.getPaymentMethodsByStoreId();
  }
  ngAfterViewInit() {
  }
  createPaymentForm() {
  ...
  getPaymentMethodsByStoreId() {
    ...
    this.authPaymentMethodAdminService.getPaymentMethodsByStoreId().pipe(takeUntil(this.ngUnsubscribe))
      .subscribe(result => {
