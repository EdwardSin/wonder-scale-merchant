...
export class ItemViewComponent implements OnInit {
  ...
  openEditItem(event) {
    this.authOnSellingItemContributorService.getItemById(event._id).pipe(takeUntil(this.ngUnsubscribe)).subscribe(result => {
      if (result) {
        this.editingItem = result['result'];
